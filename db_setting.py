...
#     cur.execute('CREATE TABLE IF NOT EXISTS unsolved_problem(problem_num int PRIMARY KEY, problem_title text, problem_lev int, problem_link text, problem_challengers int default 0)')
#     # 그룹에서 24시간 안에 푼 문제 번호 저장
#     cur.execute('CREATE TABLE IF NOT EXISTS problem_24hr(id int PRIMARY KEY)')

#     # 랭킹에 쓰이는 그룹 내 유저들의 정보 저장 (유저 아이디, 문제 수, 개인 순위)
#     cur.execute('CREATE TABLE IF NOT EXISTS personal_rank(id text PRIMARY KEY, user_solved_count int default 0, user_rank int)')

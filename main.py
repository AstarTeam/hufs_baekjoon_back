...
@app.post("/problems/{problem_num}/challengers")
def update_challengers(problem_num: int, db: Session = Depends(get_db)):
    problem = db.query(UnsolvedProblem).filter_by(problem_num=problem_num).first()
